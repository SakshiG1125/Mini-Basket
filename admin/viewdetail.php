...
include("connect.php");
include("header.php");
$sql= "SELECT * FROM `order` WHERE delete_status='0' AND status='0' AND uid='".$_GET['id']."'  ";
...
<?php
                                 ...
                                 $sql4= "SELECT * FROM `order` WHERE delete_status='0' AND status='0' AND uid='".$_GET['id']."'  ";
...
<?php
{
$sql2= "SELECT * FROM `order` WHERE delete_status='0' AND status='0' AND uid='".$_GET['id']."'  ";
$result6=$conn->query($sql2);
     $row6=$result6->fetch_assoc();
?>
<b><span>Status:</span> <?php if($row6['status']==1){
        echo "Deliverd";  
