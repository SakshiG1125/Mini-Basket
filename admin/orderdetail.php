...
WHERE id IN (SELECT uid FROM  `order` where status= 1)";
...
foreach ($result as $row) {
    ...
    <tr>
        ...
        <td>    
            <a href="view.php?id=<?php echo $row['id']?>"><input id="edit" type="submit" name="edit" value="View Order" class="btn btn-default" /></a>
