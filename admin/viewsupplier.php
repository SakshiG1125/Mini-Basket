...
$sql= "SELECT * from  supplier where delete_status='0'";
                        ...
                        <div class="col-lg-12">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <b><table><td>    
            <a href="addsupplier.php"><input id="" type="submit" name="btn" value="Add Supplier"  class="btn btn-default" /></a>
        </td></tr>
                                       </table></b>
                                    <br>
...
foreach ($result as $row) {
	...
	<tr>
		...
		<td>	
            <a href="editsupplier.php?id=<?php echo $row['id']?>"><input id="edit" type="submit" name="edit" value="Edit" class="btn btn-default" style="width: 95%;" /></a><br><br>
          <a href="deletesupp.php?id=<?php echo $row['id']?>" onclick="return confirm('Are you sure to delete this record?')">  <input id="delete" type="submit" name="delete" value="Delete"  class="btn btn-default"/></a>
        </td>
	</tr>
<?php	
}
