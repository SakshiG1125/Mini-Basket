...
$sql= "SELECT * FROM `order` WHERE date BETWEEN '" .$_POST['frmdate']. "' AND  '" .$_POST['todate']. "' AND status='0'";
...
if($conn->query($sql)==TRUE)
  ...
  {
    $sql= "SELECT * FROM `order` WHERE delete_status='0' AND status='0' ";
    $result=$conn->query($sql);
}
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <form role="form">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control"name="frmdate" type="date" placeholder="Enter Date" required>
                                                ...
                                                <div class="form-group">
                                                    <label>To Date</label>
                                                    <input class="form-control"name="todate" type="date" placeholder="Enter Date" required>
                                                    
                                                </div>
                                                </div>
                                                <div class="col-lg-4">
                                <div class="form-group">
                                        <button type="submit" class="btn btn-default" name="btn" style="margin-top: 25px;">Submit</button></div></div>                                        </div>         
                                </div>
                             </form>  
   </div>
                                        <!-- /.col-lg-6 (nested) -->
